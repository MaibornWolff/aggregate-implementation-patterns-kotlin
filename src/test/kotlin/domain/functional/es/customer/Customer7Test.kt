...
import domain.functional.es.customer.Customer7.changeEmailAddress
import domain.functional.es.customer.Customer7.confirmEmailAddress
...
internal class Customer7Test {
    ...
    private var currentState: CustomerState? = null
    ...
    private fun WHEN_ConfirmEmailAddress_With(confirmationHash: Hash?) {
        ...
        try {
            recordedEvents = confirmEmailAddress(currentState!!, command)
    ...
    private fun WHEN_ChangeEmailAddress_With(emailAddress: EmailAddress?) {
        ...
        try {
            recordedEvents = changeEmailAddress(currentState!!, command)
